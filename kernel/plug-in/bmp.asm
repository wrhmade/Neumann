...
/* ���顼�����ɤ��֤����Ȥꤢ������0�ˤ��Ƥ���� */
env��64KB�Υ�����ꥢ�Ǥ��롣��Ƭ8dw���֤����ѤˤʤäƤ��롣
��ȯ���餷��, ���󥹥����ѿ�Ū�ˤϻȤ��ʤ��褦����JPEG_init��
base_img����Τ�decode�ΤȤ������Ǥ����Ȼפ���
%endif

[absolute 0]	;nask�ʤ�[section .bss] org 0 ���� win32��������ᤫ
bmpinfo:
.regs:		resd 4
.reteip:	resd 1
.env:		resd 1
...
.endif:
	...
	mov edx, eax
	add eax, byte 3			;size<1GB���ꤷ��edx��̵� 
	...
	pop edx
	add esi, eax
	add esi, edx			;�ǽ��ԤκǸ�ˤ�pudding���ʤ��ȸ���٤�
...
.bpp24:
	...
	.do24.1:
	  ...
	  .do24.2:
	    ...
	    mov ax, [esi]
	     add esi, byte 3
	    ;�������� eax=24bitColor, edx=work, ecx=counter, ebx=work
	    ;��礵��μ�̣���פä��롼�������äƤ����褷(��
	    ;�����Ȼ��롼�������äƤ����褷
